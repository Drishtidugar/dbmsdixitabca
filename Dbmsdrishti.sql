create table Student ( No int(2), Name varchar(15), School varchar(15), Hobby varchar(20), Std int(1), Gender varchar(1) );
insert into Student (NO , Name , School , Hobby , Std , Gender)
